    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If My.Settings.testul_1 = "0" Then
            ...
            If Not (fileReader = "") Then
                RichTextBox1.Text += Environment.NewLine + "[STAGE 1] Python este instalat."
            ...
            End If
        Else
            RichTextBox1.Text += Environment.NewLine + "[STAGE 1] Python este deja instalat."
        End If
        ...
        Else
            ...
            If System.IO.File.Exists("updater.py") Then
                ...
                End If
            Else
                RichTextBox1.Text += Environment.NewLine + "[UPDATER] Nu am gasit updater.py, se descarcă oricum."
                File.WriteAllText("updater.py", updater)
                Process.Start("cmd", "/c py updater.py")
                Me.Close()
            End If
        ...
        If My.Settings.testul_2 = "0" Then
            ...
            If fileReader.StartsWith("Requirement") Then
                RichTextBox1.Text += Environment.NewLine + "[STAGE 2] Requests este instalat deja."
            Else
                RichTextBox1.Text += Environment.NewLine + "[STAGE 2] Modulul Requests s-a instalat."
            End If

            fileReader = My.Computer.FileSystem.ReadAllText("temp_b.txt")
            If fileReader.StartsWith("Requirement") Then
                RichTextBox1.Text += Environment.NewLine + "[STAGE 2] Dpath este instalat deja."
            Else
                RichTextBox1.Text += Environment.NewLine + "[STAGE 2] Modulul Dpath s-a instalat."
            End If

            fileReader = My.Computer.FileSystem.ReadAllText("temp_c.txt")
            If fileReader.StartsWith("Requirement") Then
                RichTextBox1.Text += Environment.NewLine + "[STAGE 2] Xlwt este instalat deja."
            Else
